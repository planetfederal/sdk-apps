...
class MyApp extends App {
  render() {
    var options = [{
      exclude: true,
      pullRight: false,
      jsx: (<article><img src="resources/logo.svg" width="30" height="30"></img><span className='app-title'>Styling</span></article>)
    }];
    return (
      <article>
        <Toolbar options={options} />
        <div ref='map' id='map'></div>
        <div><LayerList showOnStart={true} showZoomTo={true} allowStyling={true} allowReordering={true} addLayer={{url: 'http://demo.boundlessgeo.com/geoserver/wms?', asVector: true}} expandOnHover={false} map={map} /></div>
