...
class MyApp extends App {
  render() {
    var options = [{
      exclude: true,
      pullRight: false,
      jsx: (<article><img src="logo.svg" width="30" height="30"></img><span className='app-title'>Styling</span></article>)
    }];
    return (
      <article>
        <Toolbar options={options} />
        <div ref='map' id='map'></div>
        <div><LayerList showZoomTo={true} allowLabeling={true} allowReordering={true} addLayer={{url: 'http://localhost:8080/geoserver/wfs?', asVector: true}} expandOnHover={false} map={map} /></div>
