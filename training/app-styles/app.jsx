  ...
  render() {
    return (
      <div id='content'>
        ...
        <div><LayerList showOnStart={true} showZoomTo={true} allowStyling={true} allowReordering={true} addLayer={{sources: [{url: '/geoserver/ows', type: 'WFS', title: 'Local GeoServer'}]}} expandOnHover={false} map={map} /></div>
